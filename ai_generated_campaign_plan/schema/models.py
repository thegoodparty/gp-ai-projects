...
class CampaignInfo(BaseModel):
    ...
    primary_date: date | None = Field(None, description="Primary election date if necessary")
    ...
    incumbent_status: IncumbentStatus | None = Field(None, description="If incumbent, were they elected or appointed")
    ...
    additional_race_context: str | None = Field(None, description="Additional context about race themes, district dynamics, turnout trends, etc.")
...
class AdditionalCampaignInfo(BaseModel):
    ...
    primary_date_formatted: str | None = Field(None, description="The primary date formatted as YYYY-MM-DD if exists")
