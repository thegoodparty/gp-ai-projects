...
class DataLoader:
    ...
    def __init__(self, config: PipelineConfig):
        ...
        self.data_files = getattr(config, 'data_files', {
            "josh": "serve/data/josh_all_rounds_consolidated.csv",
            "cara": "serve/data/cara_all_rounds_consolidated.csv",
            "berkeley": "serve/data/berkley_all_rounds_consolidated.csv",
            "heather": "serve/data/heather_all_rounds_consolidated.csv",
            "japjeet": "serve/data/japjeet_all_rounds_consolidated.csv",
            "joanna": "serve/data/joanna_all_rounds_consolidated.csv",
            "jonathan": "serve/data/jonathan_all_rounds_consolidated.csv"
        })

    def _find_data_file(self, filename: str) -> Path:
        """Find data file with multiple path fallbacks"""
        possible_paths = [
            Path(filename),
            Path("../../..") / filename,
            Path("/Users/collinpark/work/gp-ai-projects") / filename
        ]
